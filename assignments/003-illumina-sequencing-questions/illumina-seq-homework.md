...
They are complementary (opposite of each other)
...
oligonucleotide - short single or double-stranded fragments of DNA or RNA (less than 50 nucleotides in length)

polymerase - an enzyme that catalyzes the synthesis of a DNA or RNA polymer with a sequence complementary to the original template.

3'-hydroxyl - necessary in the synthesis of new nucleic acid molecules
...
It seems to be the same, anchored by it's 3' end
...
The blue part of the remaining strand is at the 5' end and is the same as the blue oligos on the lawn.
...
I think so, what I'm confused on is whether or not they are complementary to each other
